...
const FRAUD_CASES: FraudCase[] = [
  {
    ...
    title: "热情帮忙，拎走行李一去不回",
    summary:
      "新生报到时最容易被“热心人”盯上：先快速建立信任，再制造分工场景，把你和行李分开。常见话术是“我带你办手续、同伴帮你看包”，几分钟就可能造成大额损失。防范动作：只认官方统一接待点和正规证件；现金、证件、手机、电脑不离身；遇到陌生人催你“快点走流程”，先停下来核实。",
  },
  {
    id: "dorm-sales",
    title: "路上和宿舍推销，假冒伪劣需防范",
    summary:
      "诈骗者常冒充“学长学姐/社会实践团队”，以返利、兼职、校园合作等名义上门推销。套路核心不是商品，而是让你在“熟人语气+限时优惠”里失去判断。防范动作：校内陌生上门营销一律提高警惕；不现场付款、不扫码授权、不转押金；涉及班级或社团活动须通过可核验的官方渠道确认。",
  },
  {
    id: "scan-lottery",
    title: "莫贪小利，警惕商家霸王消费",
  ...
  },
  {
    ...
    summary:
      "校园贷套路通常从“无抵押、低利率、秒放款”开始，真正放款时却层层扣除中介费、服务费、展期费。表面上借了钱，实际到手金额很少，后续又被滚动收费拖入债务循环。防范动作：远离非正规平台与私人中介；资金紧张优先走国家助学贷款、绿色通道和正规银行渠道；任何借贷合同先请懂法亲友复核。",
  },
  {
    id: "mlm",
    title: "高度警戒，远离非法传销",
  ...
  },
  {
    ...
    summary:
      "“小额借钱”诈骗常通过连续、急迫、可怜叙事来降低你的防备，让你在同情中忽略核验。单次金额不大，但高频反复会累计成明显损失。防范动作：借款前先核实身份、用途和归还计划；尽量不现金交易，保留聊天与转账记录；对方若回避核验、反复催促，及时止损并向警方求助。",
  },
];
      ...
      <FlipScreenStory
        ...
        slides={[
          ...
          })),
          {
            ...
            title: "记住三条铁律",
            text:
              "看完案例你也许会想“我不会被骗”，但很多受害者在转账前一秒也这么想。请记住三条铁律：第一，凡是让你先交钱的“好事”，大概率是坏事；第二，凡是催你立刻转账的“老师/学长/客服”，先挂断再核实；第三，只要觉得不对劲，立刻向警方或砺志励行小助手求助。宁可多核验一次，也不要让一次冲动决定带来长期损失。",
            imageSrc: splashSrc,
            imageAlt: "识诈防骗结尾图",
          },
        ]}
